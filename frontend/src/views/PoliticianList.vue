            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-10 card p-6">
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="flex-1">
                            <input v-model="searchQuery" type="text" placeholder="정치인 이름으로 검색..." class="input-field">
                        </div>
                        <div class="flex gap-3">
                            <select v-model="selectedParty" class="input-field w-48">
                            ...
                            <select v-model="selectedRegion" class="input-field w-48">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <div v-for="politician in filteredPoliticians" :key="politician.id"
                        @click="goToPoliticianDetail(politician.id)" class="card cursor-pointer group">
                        <div class="p-6">
                            <!-- 프로필 이미지 -->
                            <div
